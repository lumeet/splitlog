...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(1), __webpack_require__(2), __webpack_require__(9)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, _app, _reporter, _websocket) {
	  'use strict';
	  ...
	  (0, _ws['default'])(_reporter2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, module, __webpack_require__(3), __webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function (exports, module, _jquery, _colorGenerator) {
	  'use strict';
	  ...
	  var _color = _interopRequireDefault(_colorGenerator);

	  var parseData = function parseData(event) {
	    return JSON.parse(event.data);
	  };

	  var colorize = function colorize(groupId) {
	    return ensureGroup(groupId).color;
	  };

	  var leftPosition = function leftPosition(groupId) {
	    return ensureGroup(groupId).index * 20;
	  };

	  var ensureGroup = function ensureGroup(groupId) {
	    if (groups[groupId] === undefined) {
	      groups[groupId] = { index: groupTotal,
	        color: (0, _color['default'])().hexString() };
	      groupTotal += 1;
	    }
